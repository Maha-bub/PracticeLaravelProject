...
Route::post('/districts/{id}/update', [DistrictController::class, 'update'])->name('district.update');
Route::post('/districts/{id}/delete', [DistrictController::class, 'destroy'])->name('district.destroy');
