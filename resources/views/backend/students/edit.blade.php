        ...
        <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <section class="row g-3">
                <div class="col-12 col-xl-12">
                    ...
                    <form class="panel needs-validation" action="{{ route('student.update', $student->id) }}" method="post"
                        novalidate>
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" id="name" name="fullname" type="text"
                                    value="{{ old('fullname', $student->name) }}" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" value="{{ old('email', $student->email) }}" name="email"
                                    type="email" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input class="form-control" value="{{ old('phone', $student->phone) }}" name="phone"
                                    type="tel" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="district" name="district" required>
                                    ...
                                    <option value="1"
                                        {{ old('district', $student->district) == '1' ? 'selected' : '' }}>Dhaka</option>
                                    <option value="2"
                                        {{ old('district', $student->district) == '2' ? 'selected' : '' }}>Sylhet
                                    </option>
                                    <option value="3"
                                        {{ old('district', $student->district) == '3' ? 'selected' : '' }}>Rangpur
                                    </option>
                                    <option value="4"
                                        {{ old('district', $student->district) == '4' ? 'selected' : '' }}>Bogura
                                    </option>
                                </select>
