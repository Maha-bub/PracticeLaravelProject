            ...
            <section class="row g-3">
                <div class="col-12 col-xl-4">
                    <div class="panel h-100 text-center profile-card">
                        ...
                        <img class="avatar-img avatar-xl profile-photo" src="../assets/images/avatar/avatar.jpg"
                            alt="Admin Hasan">
                        <h2 class="h5 mt-3 mb-1">{{ old('name', $student->name) }}</h2>
                ...
                <div class="col-12 col-xl-8">
                    <form class="panel needs-validation" novalidate>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6"><label class="form-label" for="fullname">Name</label><input
                                    class="form-control" id="profileName" type="text"
                                    value="{{ old('name', $student->name) }}" required>
                                <div class="invalid-feedback">Name is required.</div>
                            </div>
                            <div class="col-md-6"><label class="form-label" for="profileEmail">Email</label><input
                                    class="form-control" id="profileEmail" type="email"
                        ...
                        <div class="d-flex justify-content-end mt-4"><button class="btn btn-primary" type="submit"><i
                                    class="bi bi-check2-circle" aria-hidden="true"></i> Save Profile</button></div>
                    </form>
                </div>
            </section>
        </div>
